...
#%%
a = sample_sheet[sample_sheet['Data Type'] == 'Protein Expression Quantification']
# %%
...
# %%
stats.to_csv('temp/protein_expression_quantification/stats.csv')
# %%
#%%
sample_sheet = sample_sheet['']
sample_sheet['Sample ID'].apply(lambda x: x.split('-')[-1][-1])
#%%
sample_sheet[sample_sheet['Sample ID'].isna()]