...
#%%
a = sample_sheet[sample_sheet['Data Type'] == 'Masked Somatic Mutation']
#%%
(a['Case ID'].apply(lambda x: len(x.split(','))) != 2).sum()
# %%
b = []
...
df
#%%
df.to_csv('temp/masked_somatic_mutation/stats.csv')
# %%
